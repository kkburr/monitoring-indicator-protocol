...
import (
	"github.com/pivotal/indicator-protocol/k8s/pkg/client/clientset/versioned"
	...
	informers "github.com/pivotal/indicator-protocol/k8s/pkg/client/informers/externalversions"
)
