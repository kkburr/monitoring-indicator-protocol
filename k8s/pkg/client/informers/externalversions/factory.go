...
type SharedInformerFactory interface {
	...
	Apps() indicatordocument.Interface
}

func (f *sharedInformerFactory) Apps() indicatordocument.Interface {
	return indicatordocument.New(f, f.namespace, f.tweakListOptions)
}
